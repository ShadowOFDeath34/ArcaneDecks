...
public class Game1 : Game
{
    ...
    public Game1()
    {
        ...
        if (!string.IsNullOrEmpty(sentryDsn))
        {
            ...
            {
                o.Dsn = sentryDsn;
                o.Release = "arcane-decks-ios@1.0.0";
    ...
    protected override void LoadContent()
    {
        ...
        var apiBaseUrl = Environment.GetEnvironmentVariable("ARCANE_API_URL") ?? "https://arcane-decks-api.vercel.app";
        var httpClient = new HttpClient();
        var storagePath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "Save");
        ...
        var adService = new iOSAdService();
        adService.Initialize();

        var iapService = new iOSIAPService();
        iapService.Initialize();

        var steamService = new iOSSteamService();
    ...
    protected override void Update(GameTime gameTime)
    {
        try
        {
            ...
            {
                // iOS platform policy does not allow programmatic exit.
            }
